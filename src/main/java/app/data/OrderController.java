...
/**
 * Can be used to extend or override the insert/update/delete processing.
 *
 * <p>Extend: typically setting property values (e.g. audit columns) and returning true so that
 * Ebean continues the insert OR
 *
 * <p>Override: handle the insert processing yourself (call a stored procedure etc and return false
 * so that Ebean doesn't continue processing the insert.
 */
